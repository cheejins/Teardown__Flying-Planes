...
function createPlaneObject(_vehicle)
    ...
    plane.update = function ()
        ...
        plane.pos = plane.tr.pos
        plane.rot = plane.tr.rot
        plane.dir = QuatToDir(plane.tr.rot) --!

        plane.vel = GetBodyVelocity(plane.body)
        plane.velTotal = (math.abs(plane.vel[1]) +  math.abs(plane.vel[2]) +  math.abs(plane.vel[3]))

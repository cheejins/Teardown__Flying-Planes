...
function init()
    ...
    if GetString('savegame.mod.options.keys.respawn') == '' then
        SetString('savegame.mod.options.keys.respawn', 'u')
    end
    ...
    if GetString('savegame.mod.options.keys.toggleMissileLock') == '' then
        SetString('savegame.mod.options.keys.toggleMissileLock', 'y')
    end
...
function draw()
    ...
    do UiPush()
        ...
        do UiPush()
            ...
            Ui_Option_Keybind('Toggle In-Game Options', 'savegame.mod.options.keys.smallMapMode')
